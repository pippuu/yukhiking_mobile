...
class ExplorasiPage extends StatefulWidget {
  final int id_user;
  const ExplorasiPage({Key? key, required this.id_user}) : super(key: key);
  @override
                          ...
                          return GestureDetector(
                              onTap: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) =>
                                        Detail(detailBarang: data[idx], id_user: widget.id_user)));
                              },
                              child: Container(
                                  width: 200.0,
                                  margin:
...
class Detail extends StatefulWidget {
  ...
  final int id_user;
  const Detail({Key? key, required this.detailBarang, required this.id_user}) : super(key: key);
  @override
                      ...
                      ElevatedButton(
                        onPressed: () {
                          if (widget.detailBarang.stock >=
                            ...
                            sendItemData(widget.detailBarang.itemID, widget.id_user,
                                int.parse(_controllerJumlahSewa.text));
                          } else {
                            // alert dialog
                            showDialog<String>(
